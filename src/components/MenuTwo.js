...
class MenuTwo extends Component {
    ...
    render() { 
        ...
        return (
                    ...
                    <div className="header__logo hihe-on-tablet">
                        <a href="/" className="header__logo-link">
                        <svg className="header_logo-img" viewBox="0 0 192 65">
                            <g fillRule="evenodd">
  ...
  <div className="header__search-input-wrap">
    <input name="product_price" onChange={ (event) => this.isChange(event)} type="text" className="header__search-input"  placeholder="Nhập để tìm kiếm sản phẩm" />
    <div className="header__search-history">
      <h3 className="header__search-history-heading">
        Lịch sử tìm kiếm 
      </h3>
      <ul className="header_search-history-list">
        <li className="header_search-history-item">
  ...
  <div className="header__search-btn" onClick={(dl) =>this.props.checkConnectProps(this.state.tempValue)}>
    <i className="header__search-btn-icon fas fa-search" />
                    ...
                    <div className="header__cart">
                        ...
                        {/* <div class="header__cart-list header_car-list--no-cart">
                                        <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/f3540f6657bbdc1120e3f8cc90bdba97.png" alt="ảnh sản phẩm" class="header_cart-no-cart-img">
                        ...
                        <div className="header__cart-list header_car-list--no-cart">
                            ...
                            <li className="header__cart-item">
                                <img src="https://cf.shopee.vn/file/af06ee91c5021a408a8330c94fb9b0cb_tn" alt="Ảnh sản phẩm" className="header__cart-img" />
                                <div className="header__cart-item-info">
                                <div className="header__cart-item-head">
                                    <h5 className="header__cart-item-name">Bộ kem đặt trị vùng mắt</h5>
